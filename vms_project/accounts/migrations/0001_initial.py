    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('super_admin', 'Super Admin'), ('admin', 'Organization Admin'), ('employee', 'Employee'), ('security', 'Security'), ('reception', 'Reception')], default='employee', max_length=20)),
